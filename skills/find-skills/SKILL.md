...
- Mentions they wish they had help with specific domain (design, testing, deployment, etc.)
...
- `npx skills add <package>` - Install skill from GitHub or other sources
...
- User asks "I need to create changelog" → `npx skills find changelog`
