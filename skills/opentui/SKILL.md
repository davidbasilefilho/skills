...
- in repo, that same slug maps to `packages/web/src/content/docs/<slug>.mdx`
...
- Prefer current entry pages first, then read narrower docs in same section.
- Read sibling `docs/**/*.mdx` files directly instead of copying prose into this file.
