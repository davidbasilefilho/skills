...
# Box
 ...
 container component with borders, background colors, and layout capabilities. Use it to create panels, frames, and organized sections.
...
Add title and bottom title to box border:
...
Box works as flex container for child elements:
...
Handle mouse interactions on box:
