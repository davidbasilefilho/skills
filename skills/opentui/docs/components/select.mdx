...
# Select
 ...
 vertical list for choosing from multiple options. Focus select to enable keyboard input.
...
When focused, select responds to these keys:
...
Fires when user presses Enter on option:
...
Fires when highlighted item changes:
