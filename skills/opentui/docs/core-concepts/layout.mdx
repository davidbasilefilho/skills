...
OpenTUI uses Yoga layout engine to provide CSS Flexbox-like capabilities for responsive terminal layouts. create complex, dynamic interfaces that adapt to terminal size changes.

## Flexbox Basics

 layout system supports standard flexbox properties:
...
Control direction of child elements:
...
Elements flow normally in layout:
...
## Using Constructs
 ...
 same layout properties work with declarative API:
