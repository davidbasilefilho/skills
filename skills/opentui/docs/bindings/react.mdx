...
If your app loads external TS/TSX modules at runtime (for example file-based plugin system), import this once in your app entry before dynamic imports:
...
Creates React root for rendering into terminal.
...
Style components with props or `style` prop:
